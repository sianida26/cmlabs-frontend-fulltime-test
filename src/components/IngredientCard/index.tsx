...
export default function IngredientCard(props: Props) {
  return (
    <div className="w-full p-6 rounded-xl bg-white flex flex-col overflow-clip hover:scale-110 transition duration-500" style={{ boxShadow: "4px 4px 16px 4px rgba(0, 0, 0, 0.25)" }}>
