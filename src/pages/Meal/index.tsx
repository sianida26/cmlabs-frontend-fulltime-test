		...
		<div className="w-screen min-h-screen bg-lightGreen jost flex flex-col pb-8">
			{isLoading ? (
				...
				<img
					...
					alt=""
					className="w-full aspect-square object-cover md:h-72"
				/>
			)}

			<div className="px-4 mt-8 max-w-screen-lg lg:pl-12 lg:self-center">
				{isLoading ? (
					<>
				...
				<div className="flex flex-col md:flex-row">
					<div className="mt-4">
						<h2 className="text-xl font-semibold montserrat mb-2">
							What You'll Need:
						</h2>

						{/* Ingredients */}
						<div className="w-full grid grid-cols-1 gap-4 md:gap-2">
							{isLoading
